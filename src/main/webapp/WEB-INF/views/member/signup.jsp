...
<form role="form" action="/member/signup" method="post">
	<div id="cont-2">
            ...
            <div id="cont-cont">
                <ul id="signup">
                    <li>
                        <div class="need">아이디<span>*</span></div>
                        <div class="needs">
                            <div id="id">
                                <input type="text" id="signup_userid" name="userid">
                    ...
                    <li>
                        ...
                        <div class="needs">
                            <div id="name">
                                <input type="text" id="name1" name="username" maxlength="8" >
            ...
            <div id="signup_btn">
                <button type="submit" id="signup_button">가입</button>  <button type="reset">취소</button>
            </div>
	</div>
</form>	
</div>
